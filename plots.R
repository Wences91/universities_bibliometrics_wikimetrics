...
wiki_metrics_names <- c('Age', 'Characters', 'Words', 'Sections', 'Edits',
                        'Editors', 'Total views', 'International views',
                        'Local views', 'Language links', 'References',
                        'Unique references')
wiki_metrics_names_org <- c('age', 'characters', 'words', 'sections', 'revisions',
                            'editors', 'total_views', 'int_views',
                            'local_views', 'langlinks', 'references',
                            'unique_references')


df <- df[,c(biblio_ind_names_org, wiki_metrics_names_org)]
map <- setNames(c(biblio_ind_names, wiki_metrics_names), c(biblio_ind_names_org, wiki_metrics_names_org))
